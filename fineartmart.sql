...
("prints", "Girl with a Pearl Earring", "Johannes Vermeer", 52.99, 150), 
("prints", "Guernica", "Pablo Picasso", 50.99, 82), 
("prints", "The Last Supper", "Leonardo da Vinci", 89.99, 16), 
("prints", "The Creation of Adam", "Michelangelo", 26.99, 52), 
("prints", "Landscape with the Fall of Icarus", "Pieter Bruegel", 17.99, 43), 
("prints", "Starry Night", "Vincent Van Gogh", 50.99, 94), 
("prints", "Water Lilies", "Claude Monet", 52.99, 12), 
("prints", "The Scream", "Edvard Munch", 30.99, 23), 
("prints", "The Arnolfini Marriage", "Jan van Eyck", 45.99, 81), 
...
("prints", "La Moulin de la Galette", "Pierre-Auguste Renoir", 42.99, 36), 
("prints", "The Kiss", "Gustav Klimt", 75.99, 76), 
...
("prints", "Whistler’s Mother", "James McNeill Whistler", 60.99, 62), 
("prints", "The Flower Carrier", "Diego Rivera", 12.99, 19), 
("prints", "American Gothic", "Grant Wood", 92.99, 87), 
("prints", "The Dance", "Henri Matisse", 51.99, 46), 
("prints", "A Sunday Afternoon on the Island of La Grande Jatte", "Georges Suerat", 80.99, 68), 
("prints", "Massacre of the Innocents", "Peter Paul Rubens", 46.99, 22), 
("prints", "Royal Red and Blue", "Mark Rothko", 23.99, 35), 
("prints", "The Son of Man", "Rene Magrittees", 35.99, 15), 
("prints", "No.5, 1948", "Jackson Pollock", 19.99, 19), 
